...
#define GM_CONFIG_PATH CONFIG_PATH "/gmtok"
#endif // #ifndef GM_CONFIG_PATH
...
token_spec_t token_specific = {
	...
	// Elliptic Curve
    &token_specific_ec_sign,                // ec_sign
    &token_specific_ec_verify,              // ec_verify
	&token_specific_ec_generate_keypair,    // ec_generate_keypair
