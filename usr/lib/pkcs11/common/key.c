...
// sm2_publ_check_required_attributes()
//
CK_RV
sm2_publ_check_required_attributes( TEMPLATE *tmpl, CK_ULONG mode )
{
   return publ_key_check_required_attributes( tmpl, mode );
}
...
//
CK_RV
sm2_priv_check_required_attributes( TEMPLATE *tmpl, CK_ULONG mode )
{
   return priv_key_check_required_attributes( tmpl, mode );
}
