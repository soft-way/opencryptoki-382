...
#define CKK_SM4                        CKM_VENDOR_DEFINED + 0x00010001
#define CKK_SM2                        CKM_VENDOR_DEFINED + 0x00010002
#define CKM_SM2_KEY_PAIR_GEN           CKM_VENDOR_DEFINED + 0x00010003
#define CKM_SM2                        CKM_VENDOR_DEFINED + 0x00010004
#define CKM_SM2_SM3                    CKM_VENDOR_DEFINED + 0x00010005
#define CKM_SM2_ENCRYPT                CKM_VENDOR_DEFINED + 0x00010006
#define CKM_SM3                        CKM_VENDOR_DEFINED + 0x00010007
#define CKM_SM4_KEY_GEN                CKM_VENDOR_DEFINED + 0x00010008
#define CKM_SM4_ECB                    CKM_VENDOR_DEFINED + 0x00010009
#define CKM_SM4_CBC                    CKM_VENDOR_DEFINED + 0x0001000A
#define CKM_SM4_MAC_GENERAL            CKM_VENDOR_DEFINED + 0x0001000B
#define CKM_SM4_MAC                    CKM_VENDOR_DEFINED + 0x0001000C
#define CKM_ISO2_SM4_MAC_GENERAL       CKM_VENDOR_DEFINED + 0x0001000D
#define CKM_ISO2_SM4_MAC               CKM_VENDOR_DEFINED + 0x0001000E
#define CKM_SM4_ECB_ENCRYPT_DATA       CKM_VENDOR_DEFINED + 0x0001000F
